...
# %% auto 0
__all__ = ['DATA_DIR', 'DATA_FILE', 'original_df', 'year_range', 'from_year', 'to_year', 'selected_df', 'selected_data_grid',
           'window_size', 'poly_order', 'plot_view', 'on_range_change', 'update_selected_datagrid',
           'on_poly_order_change', 'on_window_size_change', 'output_plot']
