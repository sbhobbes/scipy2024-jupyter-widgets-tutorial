...
desc_and_ctrl_box = widgets.VBox(children=(intro_text, data_source_text, year_range, curve_parameter_widgets))

# %% ..\02c_layout.ipynb 52
# %answer key/dashboard/main.py 52

# how might we add padding to each of the widgets
for child in desc_and_ctrl_box.children:
...
data_box = widgets.VBox(children=(selected_data_accordion, plot_view))
